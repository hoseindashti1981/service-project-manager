...
export function TodayActivitiesPage() {
  ...
  useEffect(()=>{if(!loading&&window.location.hash.startsWith('#activity-'))document.getElementById(decodeURIComponent(window.location.hash.slice(1)))?.scrollIntoView({block:'center'})},[loading,activities])
  useEffect(() => {
