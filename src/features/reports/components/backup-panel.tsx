...
export function BackupPanel() {
  ...
  async function choose(file:File) {
    ...
    if (file.size > MAX_FILE_BYTES) throw new Error('حجم فایل بیش از حد مجاز این نسخه (۲۰۰ مگابایت، شامل عکس‌ها) است.')
    let value:unknown
  ...
  return <section className="space-y-4 rounded-2xl border bg-white p-5">
    <div><h3 className="font-bold">پشتیبان‌گیری و بازیابی</h3><p className="mt-1 text-sm text-slate-500">شامل همهٔ اطلاعات، عکس‌ها، تنظیمات کسب‌وکار، یادآورها، تاریخچه وضعیت پروژه و سوابق اصلاح فعالیت‌ها. فایل را در جایی خارج از این دستگاه هم نگه دارید.</p></div>
