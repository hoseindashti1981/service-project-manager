...
export function ReportsPage() {
  ...
  useEffect(() => {
    const subscription = liveQuery(async () => {
      const [account,projects]=await Promise.all([readAccount(),projectRepository.getAll()])
      const income=account.receivable
