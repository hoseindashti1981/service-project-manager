...
function RootContent() {
  ...
  return <div data-app-shell style={{"--brand-color":business.color} as CSSProperties} className="min-h-screen bg-slate-50 text-slate-900">
    ...
    <main className={`mx-auto max-w-6xl px-4 py-6 pb-24 lg:mr-64 lg:px-8 lg:pb-8 ${dashboard ? "max-sm:px-3 max-sm:pt-3 max-sm:pb-[calc(5rem+env(safe-area-inset-bottom))]" : ""}`}>{dashboard && business.banner && <img src={business.banner} alt="بنر کسب‌وکار" className="mb-3 max-h-40 w-full object-cover rounded-xl" />}<Outlet /></main>
