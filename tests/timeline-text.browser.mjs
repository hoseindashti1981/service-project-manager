...
try {
 ...
 assert.equal(await activity.evaluate(e=>getComputedStyle(e).animationName),'activity-target-flash')
 await page.waitForFunction(()=>!location.hash)
 assert.equal(await activity.evaluate(e=>getComputedStyle(e).animationName),'none')
